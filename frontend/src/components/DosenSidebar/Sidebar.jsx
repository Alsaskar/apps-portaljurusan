              ...
              {dosenSubmenuOpen && (
                <ul className={`submenu ${dosenSubmenuOpen ? "open" : ""}`}>
                  <li className="submenu-item">
                    <Link to="/dosen/data/dosen" className="submenu-link" onClick={() => handleSubmenuClick("Data Dosen")}>
                      <span className="menu-link-icon">
                ...
                <ul className={`submenu ${bimbinganSubmenuOpen ? "open" : ""}`}>
                  <li className="submenu-item">
                    <div className="submenu-link">
                      ...
                      <Link to="/dosen/bimbingan" className={`submenu-link-text`} onClick={() => handleSubmenuClick("Bimbingan Dosen Wali")}>
                        Bimbingan
                      </Link>
                    </div>
                  </li>
            ...
            <li className={`menu-item`}>
              ...
              {rpsSubmenuOpen && (
                <ul className={`submenu ${rpsSubmenuOpen ? "open" : ""}`}>
                  <li className="submenu-item">
                    <Link to="/dosen/add/rps" className="submenu-link" onClick={() => handleSubmenuClick("Data RPS")}>
                      <span className="menu-link-icon">
                  ...
                  <li className="submenu-item">
                    <Link to="/dosen/daftar/mata/kuliah" className="submenu-link" onClick={() => handleSubmenuClick("RPS")}>
                      <span className="menu-link-icon">
                        <IoDocumentText size={20} />
                      </span>
                      <div className={`submenu-link-text`}>Daftar Mata Kuliah</div>
                    </Link>
                  </li>
                </ul>
              )}
                ...
                <ul className={`submenu ${absensiSubmenuOpen ? "open" : ""}`}>
                  <li className="submenu-item">
                    <Link to="/dosen/add/absensi" className="submenu-link">
                      ...
                      <div className={`submenu-link-text`} onClick={() => handleSubmenuClick("Buat Absensi")}>
                        Buat Absensi
                      </div>
                    </Link>
                  </li>
                  <li className="submenu-item">
                    <Link to="/dosen/data/absensi" className="submenu-link">
                      ...
                      <div className={`submenu-link-text`} onClick={() => handleSubmenuClick("Absensi")}>
                        Absensi
                      </div>
                    </Link>
                  </li>
