...
const ModalUbahPassword = ({ isOpen, handleClose }) => {
  const { user } = useUser();
  ...
  return (
    <>
      {isOpen && (
        <div className="ubah-password-modal fade-in">
          <div className="modal-content-ubah-password fade-in">
