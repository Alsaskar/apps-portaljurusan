...
Font.register({ family: 'Poppins', src: 'path-to-your-fonts/Poppins Regular 400.ttf' });
Font.register({ family: 'Poppins600', src: 'path-to-your-fonts/Poppins SemiBold 600.ttf' });
Font.register({ family: 'Poppins500', src: 'path-to-your-fonts/Poppins Medium 500.ttf' });

const generatePdfBlob = async (result, user, evaluasiMahasiswa, formatDate) => {
          ...
          <View style={styles.konsultasi}>
            ...
            {evaluasiMahasiswa.map((val) => (
              <View style={styles.isi_content} key={val.id}>
                ...
                <View style={styles.content}>
                  <Text
                    style={[styles.section_title, styles.isi_permasalahan]}
                  >
                    {val.permasalahan}
                  </Text>
                </View>
