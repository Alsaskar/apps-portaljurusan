            ...
            <form method="post" onSubmit={handleSubmit} className="form-add-mahasiswa">
              <div className="form-content">
                ...
                <div className="form-group">
                  ...
                  <Field type="text" id="nim" name="nim" onChange={handleChange} />
                  {touched.nim && errors.nim ? <div className="error-form">{errors.nim}</div> : null}
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <Field type="text" id="kotaLahir" name="kotaLahir" onChange={handleChange} />
                  {touched.kotaLahir && errors.kotaLahir ? <div className="error-form">{errors.kotaLahir}</div> : null}
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <Field type="text" id="alamatTerakhir" name="alamatTerakhir" onChange={handleChange} />
                  {touched.alamatTerakhir && errors.alamatTerakhir ? <div className="error-form">{errors.alamatTerakhir}</div> : null}
                </div>
                <div className="form-group">
                  <label htmlFor="kota">
                    Kota <span className="important">*</span>
                  </label>
                  <Field type="text" id="kota" name="kota" onChange={handleChange} />
                  {touched.kota && errors.kota ? <div className="error-form">{errors.kota}</div> : null}
                </div>
                <div className="form-group">
                  <label htmlFor="kodePos">
                    Kode Pos <span className="important">*</span>
                  </label>
                  <Field type="text" id="kodePos" name="kodePos" onChange={handleChange} />
                  {touched.kodePos && errors.kodePos ? <div className="error-form">{errors.kodePos}</div> : null}
                </div>
                <div className="form-group">
                  <label htmlFor="angkatan">
                    Angakatan <span className="important">*</span>
                  </label>
                  <Field type="text" id="angkatan" name="angkatan" onChange={handleChange} />
                  {touched.angkatan && errors.angkatan ? <div className="error-form">{errors.angkatan}</div> : null}
                </div>
                <div className="form-group">
                  <label htmlFor="noTestMasuk">
                    No Test Masuk <span className="important">*</span>
                  </label>
                  <Field type="text" id="noTestMasuk" name="noTestMasuk" onChange={handleChange} />
                  {touched.noTestMasuk && errors.noTestMasuk ? <div className="error-form">{errors.noTestMasuk}</div> : null}
                </div>
                <div className="form-group">
                  <label htmlFor="tglTerdaftar">
                    Tanggal Terdaftar <span className="important">*</span>
                  </label>
                  <Field type="date" id="tglTerdaftar" name="tglTerdaftar" onChange={handleChange} />
                  {touched.tglTerdaftar && errors.tglTerdaftar ? <div className="error-form">{errors.tglTerdaftar}</div> : null}
                </div>
                <div className="form-group">
                  <label htmlFor="statusMasukPt">
                    Status Masuk PT <span className="important">*</span>
                  </label>
                  <Field type="text" id="statusMasukPt" name="statusMasukPt" onChange={handleChange} />
                  {touched.statusMasukPt && errors.statusMasukPt ? <div className="error-form">{errors.statusMasukPt}</div> : null}
                </div>
                <div className="form-group">
