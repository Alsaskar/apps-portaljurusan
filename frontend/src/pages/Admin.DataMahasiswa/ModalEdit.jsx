                    ...
                    <form method="post" onSubmit={handleSubmit} className="form-edit-mahasiswa">
                      <div className="form-content">
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" id="kotaLahir" name="kotaLahir" onChange={handleChange} value={values.kotaLahir} />
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" id="nim" name="nim" onChange={handleChange} value={values.nim} />
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" id="kota" name="kota" onChange={handleChange} value={values.kota} />
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" id="kodePos" name="kodePos" onChange={handleChange} value={values.kodePos} />
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" id="angkatan" name="angkatan" onChange={handleChange} value={values.angkatan} />
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" id="noTesMasuk" name="noTesMasuk" onChange={handleChange} value={values.noTesMasuk} />
                          {touched.noTesMasuk && errors.noTesMasuk ? <div className="error-form">{errors.noTesMasuk}</div> : null}
                        </div>
                        <div className="form-group">
                          <label htmlFor="statusMasukPt">
                            Status Masuk PT <span className="important">*</span>
                          </label>
                          <input type="text" id="statusMasukPt" name="statusMasukPt" onChange={handleChange} value={values.statusMasukPt} />
