            ...
            <form method="post" onSubmit={handleSubmit} className="form-add-dosen">
              <div className="form-content">
                <div className="form-group">
                  <label htmlFor="pilihDosen">
                    Pilih Dosen <span className="important">*</span>
                  </label>
                  <select id="pilihDosen" name="pilihDosen" onChange={handleChange}>
                    {touched.pilihDosen && errors.pilihDosen ? <div className="error-form">{errors.pilihDosen}</div> : null}
                    <option value="nama-dosen-1">Nama Dosen 1</option>
                    <option value="nama-dosen-2">Nama Dosen 2</option>
                  </select>
                  {touched.pilihDosen && errors.pilihDosen ? <div className="error-form">{errors.pilihDosen}</div> : null}
                </div>
                <div className="form-group">
