...
const Jadwal = () => {
      ...
      jadwal.map((val, key) => (
        <div className="matkul-tv" key={key}>
          <div className="jadwal-time-tv">
            ...
            <p className="jadwal-text-time-tv">{val.jamMulai.slice(0, 5)} - {val.jamSelesai.slice(0, 5)}</p>
          </div>
  ...
  return (
    <>
      <div className="kelas-tv">Jadwal Kelas {result?.kelas}</div>
        ...
        <table className="jadwal-table-tv">
          ...
          <tbody className="jadwal-body-tv">
            ...
            <tr className="jadwal-contents-tv">
              <td className="jadwal-content-tv">{renderJadwal(seninJadwal.beforeBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(selasaJadwal.beforeBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(rabuJadwal.beforeBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(kamisJadwal.beforeBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(jumatJadwal.beforeBreak)}</td>
            </tr>
            ...
            <tr className="jadwal-contents-tv">
              <td className="jadwal-content-tv">{renderJadwal(seninJadwal.afterBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(selasaJadwal.afterBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(rabuJadwal.afterBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(kamisJadwal.afterBreak)}</td>
              <td className="jadwal-content-tv">{renderJadwal(jumatJadwal.afterBreak)}</td>
            </tr>
          </tbody>
        </table>
      </div>
